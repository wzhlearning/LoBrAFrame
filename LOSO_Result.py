...
'''
We save the results of test set for every epoch and use the final epoch’s performance as the results, rather than the best.
'''
...
for n_sub in range(1, all_sub+1):
    ...
    # This is a real test set. Read the last record as the final result, not the highest value.
